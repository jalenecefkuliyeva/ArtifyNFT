...
import footerpng from "../media/img/project1.png";
        ...
        <div className="footer">
          ...
          <div className="photo">
            ...
            <div className="text ">
              <nav className="nav">
                <ul>
                  <li>
                    <a href="/">{lang ==="az"?"Ana Sehife":"Home"}</a>
                  </li>
                  <li>
                    <a href="/about">{lang ==="az"?"Haqqinda":"About"}</a>
                  </li>
                  <li>
                    <a href="/products">{lang ==="az"?"NFTler":"NFTs"}</a>
                  </li>
                 
                  <li>
                    <a href="/contact">{lang ==="az"?"Elaqe":"Contact"}</a>
                  </li>
                </ul>
              </nav>
          ...
          <div className="text-three ">
              <nav className="nav">
                <ul>
                  <li>
                    <a href="">{lang ==="az"?"Böyük Kolleksiya":"Huge Collection"}</a>
                  </li>
                  <li>
                    <a href="">{lang ==="az"?"Yüksək Keyfiyyət":"High Quality"}</a>
                  </li>
                  <li>
                    <a href="">{lang ==="az"?"Ən Yaxşı Resurs":"Top Resource"}</a>
                  </li>
                 
                  <li>
                    <a href="">{lang ==="az"?"Böyük İcma":"Big Community"}</a>
                  </li>
                </ul>
              </nav>
